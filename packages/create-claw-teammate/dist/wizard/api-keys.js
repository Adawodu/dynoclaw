...
export async function apiKeysStep(enabledPlugins, telegramToken) {
    console.log(chalk.bold("\n  API Key Collection\n"));
    console.log(chalk.dim("  Keys are stored in GCP Secret Manager — never in code.\n"));
    ...
    for (const keyMeta of allKeys) {
        ...
        if (keyMeta.secretName === "telegram-bot-token")
            continue;
